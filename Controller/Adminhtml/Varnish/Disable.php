 ...
 *
 *  Supported events:
 *  magecloud_cloudways_manager_varnish_disable_before
 *  magecloud_cloudways_manager_varnish_disable_after
 *
 * @package MageCloud\CloudwaysManager\Controller\Adminhtml\Varnish
 */
class Disable extends Index
{
    /**
    ...
    public function execute()
    {
        ...
        $this->_eventManager->dispatch('magecloud_cloudways_manager_varnish_disable_before',
        ...
        $this->_eventManager->dispatch('magecloud_cloudways_manager_varnish_disable_after',
