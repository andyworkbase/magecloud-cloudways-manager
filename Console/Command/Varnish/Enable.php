...
class Enable extends Command
{
    ...
    {
        $this->setName('magecloud:cloudways-manager:varnish-enable')
            ->setDescription('Enable Cloudways Varnish Service');
    }
    ...
    public function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $this->eventManager->dispatch('magecloud_cloudways_varnish_enable_before',
        ...
        if ($isError) {
            ...
            $message = 'Varnish service was enabled.';
        } else {
            $message = 'Unexpected error. Please try again later.';
        }

        $this->eventManager->dispatch('magecloud_cloudways_varnish_enable_after',
